...
/*
    ...
    pub fn create(&mut self,
                  ...
                  device_pixel_ratio: f32) {
        //let _pf = hprof::enter("create");
        //let _pf = util::ProfileScope::new("create");
...
*/
    ...
    fn add_items_to_layer(&mut self,
                          ...
                          _level: i32) {
        //let _pf = hprof::enter("add_items_to_layer");
        for item in scene_items {
            //let _pf = hprof::enter("scene item loop");
            match item.specific {
                SpecificSceneItem::DrawList(draw_list_id) => {
                    //let _pf = hprof::enter("SpecificSceneItem::DrawList");
                    // awful awful hack - fixme
                    let draw_list_items = {
                        //let _pf = hprof::enter("get_draw_list_mut");
                        let draw_list = context.resource_cache.get_draw_list_mut(draw_list_id);
                        mem::replace(&mut draw_list.items, Vec::new())
                    };

                    let auxiliary_lists = {
                        //let _pf = hprof::enter("pipeline_auxiliary_lists");
                    ...
                    for item in &draw_list_items {
                        //let _pf = hprof::enter("draw item loop");
                        ...
                        match item.item {
                            ...
                            SpecificDisplayItem::Image(ref info) => {
                                //let _pf = hprof::enter("SpecificDisplayItem::Image");
                            ...
                            SpecificDisplayItem::Text(ref text_info) => {
                                //let _pf = hprof::enter("SpecificDisplayItem::Text");
                            ...
                            SpecificDisplayItem::Rectangle(ref info) => {
                                //let _pf = hprof::enter("SpecificDisplayItem::Rectangle");
                                builder.add_solid_rectangle(&item.rect, &info.color);
                            }
                            SpecificDisplayItem::Gradient(ref info) => {
                                //let _pf = hprof::enter("SpecificDisplayItem::Gradient");
                            ...
                            SpecificDisplayItem::BoxShadow(ref box_shadow_info) => {
                                //let _pf = hprof::enter("SpecificDisplayItem::BoxShadow");
                            ...
                            SpecificDisplayItem::Border(ref info) => {
                                //let _pf = hprof::enter("SpecificDisplayItem::Border");
                    ...
                    {
                        //let _pf = hprof::enter("restore items");
                        let draw_list = context.resource_cache.get_draw_list_mut(draw_list_id);
                        draw_list.items = draw_list_items;
                    }
                }
                SpecificSceneItem::StackingContext(id, pipeline_id) => {
                    //let _pf = hprof::enter("SpecificSceneItem::StackingContext");
                ...
                SpecificSceneItem::Iframe(ref iframe_info) => {
                    //let _pf = hprof::enter("SpecificSceneItem::Iframe");
