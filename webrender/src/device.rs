...
impl VertexDescriptor {
    fn bind(&self,
        ...
        let vertex_stride = self.vertex_attributes
                                .iter()
                                .fold(0, |stride, attr| stride + attr.size_in_bytes());
        ...
        if !self.instance_attributes.is_empty() {
            instance.bind(gl);
            let instance_stride = self.instance_attributes
                                      .iter()
                                      .fold(0, |stride, attr| stride + attr.size_in_bytes());
